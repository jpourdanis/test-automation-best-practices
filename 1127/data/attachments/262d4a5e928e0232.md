...
- Name: tests/api.spec.ts >> Backend API Integration >> PUT /api/colors/:name Schema Validation >> should return 404 when updating non-existent color
- Location: e2e/tests/api.spec.ts:205:9
