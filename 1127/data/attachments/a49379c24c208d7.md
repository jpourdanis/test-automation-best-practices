...
- Name: tests/api.spec.ts >> Backend API Integration >> DELETE /api/colors/:name >> should return 404 for non-existent color deletion
- Location: e2e/tests/api.spec.ts:233:9
