...
- Name: tests/api.spec.ts >> Backend API Integration >> POST /api/colors Schema Validation >> should create a new color with valid schema
- Location: e2e/tests/api.spec.ts:101:9
