...
- Name: tests/api.spec.ts >> Backend API Integration >> POST /api/colors Schema Validation >> should return 409 for duplicate color creation
- Location: e2e/tests/api.spec.ts:113:9
