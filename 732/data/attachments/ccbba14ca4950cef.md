...
Call log:
  - waiting for locator('button.chip-main').filter({ hasText: 'Turquoise' })
...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - generic [ref=e12]: "Current color: #1980e6"
    - generic [ref=e13]:
      - generic [ref=e14]:
        - button "Change background to Ocean" [pressed] [ref=e15] [cursor=pointer]: Ocean
        - 'button "Remove color: Ocean" [ref=e17] [cursor=pointer]': ×
      - generic [ref=e18]:
