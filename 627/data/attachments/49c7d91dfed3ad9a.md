...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - generic [ref=e13]:
      ...
      - generic [ref=e26]:
        - button "Αλλαγή φόντου σε Test1777902563815" [ref=e27] [cursor=pointer]: Test1777902563815
        - 'button "Διαγραφή χρώματος: Test1777902563815" [ref=e29] [cursor=pointer]': ×
      - generic [ref=e30]:
        - button "Αλλαγή φόντου σε Test1777903329360" [ref=e31] [cursor=pointer]: Test1777903329360
        - 'button "Διαγραφή χρώματος: Test1777903329360" [ref=e33] [cursor=pointer]': ×
      - generic [ref=e34]:
        - button "Αλλαγή φόντου σε Test1777905594977" [ref=e35] [cursor=pointer]: Test1777905594977
        - 'button "Διαγραφή χρώματος: Test1777905594977" [ref=e37] [cursor=pointer]': ×
      - generic [ref=e38]:
        - button "Αλλαγή φόντου σε Test1777906290015" [ref=e39] [cursor=pointer]: Test1777906290015
        - 'button "Διαγραφή χρώματος: Test1777906290015" [ref=e41] [cursor=pointer]': ×
      - button "+ Προσθήκη χρώματος" [ref=e42] [cursor=pointer]
```
