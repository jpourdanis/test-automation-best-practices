...
+         "html": "<span aria-live=\"polite\" class=\"current-color\">Color actual: #1abc9c</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".current-color",
...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - generic [ref=e13]:
      ...
      - generic [ref=e18]:
        - button "Cambiar el fondo a Turquesa" [active] [pressed] [ref=e19] [cursor=pointer]: Turquesa
