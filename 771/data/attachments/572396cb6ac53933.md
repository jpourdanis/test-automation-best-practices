...
Locator: getByRole('button', { name: 'Cambiar el fondo a Amarillo' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: 'Cambiar el fondo a Amarillo' })
...
- main:
  ...
  - button "Cambiar el fondo a Rojo": Rojo
  - 'button "Eliminar color: Rojo"': ×
  - button "Cambiar el fondo a Turquesa" [pressed]: Turquesa
  - 'button "Eliminar color: Turquesa"': ×
  - button "+ Añadir color"
```
