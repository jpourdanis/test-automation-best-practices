...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 3.99 (foreground color: #2d1c19, background color: #cc5b49, font size: 12.8pt (17.08px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
...
+   Element has insufficient color contrast of 3.99 (foreground color: #2d1c19, background color: #cc5b49, font size: 12.8pt (17.08px), font weight: normal). Expected contrast ratio of 4.5:1",
