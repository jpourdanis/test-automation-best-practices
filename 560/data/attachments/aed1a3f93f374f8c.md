...
Received string:    "Current color: #e74c3c"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('text=Current color:')
    9 × locator resolved to <span aria-live="polite" class="current-color">Current color: #e74c3c</span>
      - unexpected value "Current color: #e74c3c"
