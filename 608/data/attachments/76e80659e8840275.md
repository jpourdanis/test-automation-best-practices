...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - generic [ref=e12]: "Current color: #7fcd5e"
    - generic [ref=e13]:
      - generic [ref=e14]:
        - button "Change background to 2nEE" [pressed] [ref=e15] [cursor=pointer]: 2nEE
        - 'button "Remove color: 2nEE" [ref=e17] [cursor=pointer]': ×
      - generic [ref=e18]:
        - button "Change background to ck3OEMw 90l7" [ref=e19] [cursor=pointer]: ck3OEMw 90l7
        - 'button "Remove color: ck3OEMw 90l7" [ref=e21] [cursor=pointer]': ×
      - generic [ref=e22]:
        - button "Change background to a" [ref=e23] [cursor=pointer]: a
        - 'button "Remove color: a" [ref=e25] [cursor=pointer]': ×
      - generic [ref=e26]:
        - button "Change background to 2" [ref=e27] [cursor=pointer]: "2"
        - 'button "Remove color: 2" [ref=e29] [cursor=pointer]': ×
      - generic [ref=e30]:
        - button "Change background to f" [ref=e31] [cursor=pointer]: f
        - 'button "Remove color: f" [ref=e33] [cursor=pointer]': ×
      - generic [ref=e34]:
        - button "Change background to tT" [ref=e35] [cursor=pointer]: tT
        - 'button "Remove color: tT" [ref=e37] [cursor=pointer]': ×
      - generic [ref=e38]:
        - button "Change background to V" [ref=e39] [cursor=pointer]: V
        - 'button "Remove color: V" [ref=e41] [cursor=pointer]': ×
      - generic [ref=e42]:
        - button "Change background to tT" [ref=e43] [cursor=pointer]: tT
        - 'button "Remove color: tT" [ref=e45] [cursor=pointer]': ×
      - generic [ref=e46]:
        - button "Change background to 2MmQc00DSRp" [ref=e47] [cursor=pointer]: 2MmQc00DSRp
        - 'button "Remove color: 2MmQc00DSRp" [ref=e49] [cursor=pointer]': ×
      - generic [ref=e50]:
        - button "Change background to tT" [ref=e51] [cursor=pointer]: tT
        - 'button "Remove color: tT" [ref=e53] [cursor=pointer]': ×
      - generic [ref=e54]:
        - button "Change background to tT" [ref=e55] [cursor=pointer]: tT
        - 'button "Remove color: tT" [ref=e57] [cursor=pointer]': ×
      - generic [ref=e58]:
        - button "Change background to 2" [ref=e59] [cursor=pointer]: "2"
        - 'button "Remove color: 2" [ref=e61] [cursor=pointer]': ×
      - generic [ref=e62]:
        - button "Change background to 2MmQc00DSRp" [ref=e63] [cursor=pointer]: 2MmQc00DSRp
        - 'button "Remove color: 2MmQc00DSRp" [ref=e65] [cursor=pointer]': ×
      - button "+ Add color" [ref=e66] [cursor=pointer]
```
