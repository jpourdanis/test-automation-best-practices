...
Locator: getByRole('button', { name: 'Αλλαγή φόντου σε Τιρκουάζ' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: 'Αλλαγή φόντου σε Τιρκουάζ' })
...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - generic [ref=e12]: "Τρέχον χρώμα: #0AdCEa"
    - generic [ref=e13]:
      - generic [ref=e14]:
        - button "Αλλαγή φόντου σε tT" [pressed] [ref=e15] [cursor=pointer]: tT
        - 'button "Διαγραφή χρώματος: tT" [ref=e17] [cursor=pointer]': ×
      - generic [ref=e18]:
        - button "Αλλαγή φόντου σε tT" [pressed] [ref=e19] [cursor=pointer]: tT
        - 'button "Διαγραφή χρώματος: tT" [ref=e21] [cursor=pointer]': ×
      - generic [ref=e22]:
        - button "Αλλαγή φόντου σε 2nEE" [ref=e23] [cursor=pointer]: 2nEE
        - 'button "Διαγραφή χρώματος: 2nEE" [ref=e25] [cursor=pointer]': ×
      - generic [ref=e26]:
        - button "Αλλαγή φόντου σε ck3OEMw 90l7" [ref=e27] [cursor=pointer]: ck3OEMw 90l7
        - 'button "Διαγραφή χρώματος: ck3OEMw 90l7" [ref=e29] [cursor=pointer]': ×
      - generic [ref=e30]:
        - button "Αλλαγή φόντου σε a" [ref=e31] [cursor=pointer]: a
        - 'button "Διαγραφή χρώματος: a" [ref=e33] [cursor=pointer]': ×
      - generic [ref=e34]:
        - button "Αλλαγή φόντου σε 2" [ref=e35] [cursor=pointer]: "2"
        - 'button "Διαγραφή χρώματος: 2" [ref=e37] [cursor=pointer]': ×
      - generic [ref=e38]:
        - button "Αλλαγή φόντου σε f" [ref=e39] [cursor=pointer]: f
        - 'button "Διαγραφή χρώματος: f" [ref=e41] [cursor=pointer]': ×
      - generic [ref=e42]:
        - button "Αλλαγή φόντου σε tT" [pressed] [ref=e43] [cursor=pointer]: tT
        - 'button "Διαγραφή χρώματος: tT" [ref=e45] [cursor=pointer]': ×
      - generic [ref=e46]:
        - button "Αλλαγή φόντου σε V" [ref=e47] [cursor=pointer]: V
        - 'button "Διαγραφή χρώματος: V" [ref=e49] [cursor=pointer]': ×
      - generic [ref=e50]:
        - button "Αλλαγή φόντου σε tT" [pressed] [ref=e51] [cursor=pointer]: tT
        - 'button "Διαγραφή χρώματος: tT" [ref=e53] [cursor=pointer]': ×
      - generic [ref=e54]:
        - button "Αλλαγή φόντου σε 2MmQc00DSRp" [ref=e55] [cursor=pointer]: 2MmQc00DSRp
        - 'button "Διαγραφή χρώματος: 2MmQc00DSRp" [ref=e57] [cursor=pointer]': ×
      - generic [ref=e58]:
        - button "Αλλαγή φόντου σε tT" [pressed] [ref=e59] [cursor=pointer]: tT
        - 'button "Διαγραφή χρώματος: tT" [ref=e61] [cursor=pointer]': ×
      - generic [ref=e62]:
        - button "Αλλαγή φόντου σε tT" [pressed] [ref=e63] [cursor=pointer]: tT
        - 'button "Διαγραφή χρώματος: tT" [ref=e65] [cursor=pointer]': ×
      - generic [ref=e66]:
        - button "Αλλαγή φόντου σε 2" [ref=e67] [cursor=pointer]: "2"
        - 'button "Διαγραφή χρώματος: 2" [ref=e69] [cursor=pointer]': ×
      - generic [ref=e70]:
        - button "Αλλαγή φόντου σε 2MmQc00DSRp" [ref=e71] [cursor=pointer]: 2MmQc00DSRp
        - 'button "Διαγραφή χρώματος: 2MmQc00DSRp" [ref=e73] [cursor=pointer]': ×
      - button "+ Προσθήκη χρώματος" [ref=e74] [cursor=pointer]
```
