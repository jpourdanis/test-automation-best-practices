...
- Name: tests/data-driven.spec.ts >> Data-Driven Testing >> changing color to Red should reflect in UI and DOM
...
Call log:
  - waiting for locator('button.chip-main').filter({ hasText: 'Red' })
...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - generic [ref=e12]: "Current color: #2e8Be2"
    - generic [ref=e13]:
      - generic [ref=e14]:
        - button "Change background to 2" [pressed] [ref=e15] [cursor=pointer]: "2"
        - 'button "Remove color: 2" [ref=e17] [cursor=pointer]': ×
      - generic [ref=e18]:
        - button "Change background to f" [ref=e19] [cursor=pointer]: f
        - 'button "Remove color: f" [ref=e21] [cursor=pointer]': ×
      - generic [ref=e22]:
        - button "Change background to V" [ref=e23] [cursor=pointer]: V
        - 'button "Remove color: V" [ref=e25] [cursor=pointer]': ×
      - generic [ref=e26]:
        - button "Change background to 2MmQc00DSRp" [ref=e27] [cursor=pointer]: 2MmQc00DSRp
        - 'button "Remove color: 2MmQc00DSRp" [ref=e29] [cursor=pointer]': ×
      - generic [ref=e30]:
        - button "Change background to 2" [pressed] [ref=e31] [cursor=pointer]: "2"
        - 'button "Remove color: 2" [ref=e33] [cursor=pointer]': ×
      - generic [ref=e34]:
        - button "Change background to 2MmQc00DSRp" [ref=e35] [cursor=pointer]: 2MmQc00DSRp
        - 'button "Remove color: 2MmQc00DSRp" [ref=e37] [cursor=pointer]': ×
      - button "+ Add color" [ref=e38] [cursor=pointer]
```
