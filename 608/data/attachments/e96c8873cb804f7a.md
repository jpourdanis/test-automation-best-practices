...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - generic [ref=e12]: "Current color: #ba0c00"
    - generic [ref=e13]:
      - generic [ref=e14]:
        - button "Change background to a" [pressed] [ref=e15] [cursor=pointer]: a
        - 'button "Remove color: a" [ref=e17] [cursor=pointer]': ×
      - generic [ref=e18]:
        - button "Change background to 2" [ref=e19] [cursor=pointer]: "2"
        - 'button "Remove color: 2" [ref=e21] [cursor=pointer]': ×
      - generic [ref=e22]:
        - button "Change background to f" [ref=e23] [cursor=pointer]: f
        - 'button "Remove color: f" [ref=e25] [cursor=pointer]': ×
      - generic [ref=e26]:
        - button "Change background to V" [ref=e27] [cursor=pointer]: V
        - 'button "Remove color: V" [ref=e29] [cursor=pointer]': ×
      - generic [ref=e30]:
        - button "Change background to 2MmQc00DSRp" [ref=e31] [cursor=pointer]: 2MmQc00DSRp
        - 'button "Remove color: 2MmQc00DSRp" [ref=e33] [cursor=pointer]': ×
      - generic [ref=e34]:
        - button "Change background to 2" [ref=e35] [cursor=pointer]: "2"
        - 'button "Remove color: 2" [ref=e37] [cursor=pointer]': ×
      - generic [ref=e38]:
        - button "Change background to 2MmQc00DSRp" [ref=e39] [cursor=pointer]: 2MmQc00DSRp
        - 'button "Remove color: 2MmQc00DSRp" [ref=e41] [cursor=pointer]': ×
      - button "+ Add color" [ref=e42] [cursor=pointer]
```
