...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 4.05 (foreground color: #2f1b19, background color: #d65544, font size: 12.8pt (17.08px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
...
+   Element has insufficient color contrast of 4.05 (foreground color: #2f1b19, background color: #d65544, font size: 12.8pt (17.08px), font weight: normal). Expected contrast ratio of 4.5:1",
