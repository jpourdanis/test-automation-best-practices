...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 3.93 (foreground color: #2c1d1a, background color: #c65e4c, font size: 12.8pt (17.08px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
...
+   Element has insufficient color contrast of 3.93 (foreground color: #2c1d1a, background color: #c65e4c, font size: 12.8pt (17.08px), font weight: normal). Expected contrast ratio of 4.5:1",
