...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 4.2 (foreground color: #311a18, background color: #e34e3e, font size: 12.8pt (17.08px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
...
+   Element has insufficient color contrast of 4.2 (foreground color: #311a18, background color: #e34e3e, font size: 12.8pt (17.08px), font weight: normal). Expected contrast ratio of 4.5:1",
