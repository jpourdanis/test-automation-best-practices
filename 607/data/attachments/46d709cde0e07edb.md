...
Locator: getByRole('button', { name: 'Cambiar el fondo a Turquesa' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: 'Cambiar el fondo a Turquesa' })
...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - generic [ref=e12]: "Color actual: #0AdCEa"
    - generic [ref=e13]:
      - generic [ref=e14]:
        - button "Cambiar el fondo a tT" [pressed] [ref=e15] [cursor=pointer]: tT
        - 'button "Eliminar color: tT" [ref=e17] [cursor=pointer]': ×
      - generic [ref=e18]:
        - button "Cambiar el fondo a tT" [pressed] [ref=e19] [cursor=pointer]: tT
        - 'button "Eliminar color: tT" [ref=e21] [cursor=pointer]': ×
      - generic [ref=e22]:
        - button "Cambiar el fondo a 2nEE" [ref=e23] [cursor=pointer]: 2nEE
        - 'button "Eliminar color: 2nEE" [ref=e25] [cursor=pointer]': ×
      - generic [ref=e26]:
        - button "Cambiar el fondo a ck3OEMw 90l7" [ref=e27] [cursor=pointer]: ck3OEMw 90l7
        - 'button "Eliminar color: ck3OEMw 90l7" [ref=e29] [cursor=pointer]': ×
      - generic [ref=e30]:
        - button "Cambiar el fondo a a" [ref=e31] [cursor=pointer]: a
        - 'button "Eliminar color: a" [ref=e33] [cursor=pointer]': ×
      - generic [ref=e34]:
        - button "Cambiar el fondo a 2" [ref=e35] [cursor=pointer]: "2"
        - 'button "Eliminar color: 2" [ref=e37] [cursor=pointer]': ×
      - generic [ref=e38]:
        - button "Cambiar el fondo a f" [ref=e39] [cursor=pointer]: f
        - 'button "Eliminar color: f" [ref=e41] [cursor=pointer]': ×
      - generic [ref=e42]:
        - button "Cambiar el fondo a tT" [pressed] [ref=e43] [cursor=pointer]: tT
        - 'button "Eliminar color: tT" [ref=e45] [cursor=pointer]': ×
      - generic [ref=e46]:
        - button "Cambiar el fondo a V" [ref=e47] [cursor=pointer]: V
        - 'button "Eliminar color: V" [ref=e49] [cursor=pointer]': ×
      - generic [ref=e50]:
        - button "Cambiar el fondo a tT" [pressed] [ref=e51] [cursor=pointer]: tT
        - 'button "Eliminar color: tT" [ref=e53] [cursor=pointer]': ×
      - generic [ref=e54]:
        - button "Cambiar el fondo a 2MmQc00DSRp" [ref=e55] [cursor=pointer]: 2MmQc00DSRp
        - 'button "Eliminar color: 2MmQc00DSRp" [ref=e57] [cursor=pointer]': ×
      - generic [ref=e58]:
        - button "Cambiar el fondo a tT" [pressed] [ref=e59] [cursor=pointer]: tT
        - 'button "Eliminar color: tT" [ref=e61] [cursor=pointer]': ×
      - generic [ref=e62]:
        - button "Cambiar el fondo a tT" [pressed] [ref=e63] [cursor=pointer]: tT
        - 'button "Eliminar color: tT" [ref=e65] [cursor=pointer]': ×
      - generic [ref=e66]:
        - button "Cambiar el fondo a 2" [ref=e67] [cursor=pointer]: "2"
        - 'button "Eliminar color: 2" [ref=e69] [cursor=pointer]': ×
      - generic [ref=e70]:
        - button "Cambiar el fondo a 2MmQc00DSRp" [ref=e71] [cursor=pointer]: 2MmQc00DSRp
        - 'button "Eliminar color: 2MmQc00DSRp" [ref=e73] [cursor=pointer]': ×
      - button "+ Añadir color" [ref=e74] [cursor=pointer]
```
