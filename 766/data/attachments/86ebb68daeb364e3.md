...
Locator: getByRole('button', { name: 'Αλλαγή φόντου σε Κίτρινο' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: 'Αλλαγή φόντου σε Κίτρινο' })

```

```yaml
- main:
  - combobox "Επιλογή Γλώσσας":
    - option "English"
    - option "Español"
    - option "Ελληνικά" [selected]
  - img "logo"
  - heading "Εφαρμογή επιλογής χρώματος" [level=1]
  - paragraph:
  ...
  - text: "Τρέχον χρώμα: #1abc9c"
  - button "Αλλαγή φόντου σε Κόκκινο": Κόκκινο
  - 'button "Διαγραφή χρώματος: Κόκκινο"': ×
  - button "Αλλαγή φόντου σε Τιρκουάζ" [pressed]: Τιρκουάζ
  - 'button "Διαγραφή χρώματος: Τιρκουάζ"': ×
  - button "+ Προσθήκη χρώματος"
```
