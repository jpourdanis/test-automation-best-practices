...
+         "html": "<span aria-live=\"polite\" class=\"current-color\">Τρέχον χρώμα: #1abc9c</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".current-color",
...
- main [ref=e4]:
  - generic [ref=e5]:
    ...
    - generic [ref=e13]:
      ...
      - generic [ref=e18]:
        - button "Αλλαγή φόντου σε Τιρκουάζ" [active] [pressed] [ref=e19] [cursor=pointer]: Τιρκουάζ
